...
public class VRC_SdkControlPanel : EditorWindow
{
    ...
    static void Init()
    {
        ...
        window.titleContent.text = "VRChat Chris";
    ...
    void OnGUI()
    {
        ...
        {
            EditorGUILayout.LabelField("No editing while its running nerd!");
            return;
        }

        EditorGUILayout.Space();
        EditorGUILayout.LabelField("VRchat modded sdk by chris", EditorStyles.boldLabel);
